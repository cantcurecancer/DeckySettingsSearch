...
None of these are filed as a decision entry yet. They go to the decisions file when the maintainer
picks them up.

1. **The Frame entry's rating.** The study asked for six stars to become two. Still six.
